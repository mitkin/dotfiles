...
Debian_menu["Debian_Applications_Science_Geoscience"] = {
	{"GRASS GIS", "x-terminal-emulator -e ".."/usr/bin/grass","/usr/share/icons/grass64.xpm"},
}
Debian_menu["Debian_Applications_Science_Mathematics"] = {
	...
	{"PerlDl", "x-terminal-emulator -e ".."/usr/bin/perldl"},
	{"Xcalc","xcalc"},
}
...
Debian_menu["Debian_Games_Action"] = {
	{"Eat the Whistle","/usr/games/etw","/usr/share/games/etw/etw.xpm"},
}
